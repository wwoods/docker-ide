...
[ "$GPU" != "yes" ] && GPU_ARGS=""
docker-compose rm -f && docker-compose build ide-ui-xfce4 && x11docker/x11docker ${GPU_ARGS} --desktop -fy --no-init --runasroot "rm -rf /fakehome/${USER}; ln -s /home/dock /fakehome/${USER}" -- --rm -- ide-ui-xfce4 xfce4-session
